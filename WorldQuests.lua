...
local RetrieveWorldQuests = function(mapId)
    ...
    -- quest object fields are: questId, x, y, inProgress, numObjectives, mapID, isQuestStart, isDaily, isCombatAllyQuest, childDepth
    if questList then
        numQuests = 0
    ...
    for mapId in next, MAP_ZONES[expansion] do
        ...
        if not C("collapsedZones")[mapId] then
            ...
            for _, questId in next, MAP_ZONES[expansion][mapId].questsSort do
                ...
                if button.quest.quality ~= nil then
